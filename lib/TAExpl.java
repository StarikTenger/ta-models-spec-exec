...
public final class TAExpl {
    private static String DETECTPATH = "/home/stariktenger/Internship2025/ta-models/";
    ...
    public static Value InitOutputFile(final Value bench, final Value _missLat, final Value _superscal,
            final Value _RSsize, final Value _robSize, final Value _lat, final Value _mayDMiss)
    ...
    public static Value HasTA(final Value g1, final Value g2, final Value cycle, final BoolValue onlyCom)
            throws IOException, InterruptedException {
        ...
        ProcessBuilder processBuilder = new ProcessBuilder("python3", prog, g1.toString(), g2.toString(), filebase,
                cycle.toString());
