...
NoTA(onlyCom) == ~HasTA(graph, graph2, currCycle, onlyCom)
-----------------------------------------------------------------------------
...
Next == /\ Exec1!Next
        ...
        /\ (*IF /\ CheckTA 
           ...
           THEN cpt' = cpt+1 /\ PrintT(cpt') \*lastBound' = GraphBound
           ELSE*) UNCHANGED <<cpt>> \*lastBound

Spec == Init /\ [][Next]_<< vars, vars2, cpt >>\*, lastBound >>
=============================================================================
